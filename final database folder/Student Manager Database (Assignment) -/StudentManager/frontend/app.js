...
// Example: "https://student-manager-api.onrender.com/api/students"
const API_URL = "https://YOUR-RENDER-APP-NAME.onrender.com/api/students";
...
async function loadStudents() {
  ...
  try {
    ...
    tbody.innerHTML = `<tr class='state-row'><td colspan='5'>⚠ Could not connect to server.</td></tr>`;
  }
}
